<?php
class F_user extends CI_Controller{
	...
	function get_list($offset, $condition, $pid){
		...
		$data['total_num'] = $this->Core_user->get_f_count($createid, $condition, $pid);
		
		$list = $this->Core_user->show_f_all($createid, $condition, $pid, $limit, $per_page);
...
//		echo "pid=".$pid;
		...
		$this->load->view('admin/f_user_list', $data);
	}
