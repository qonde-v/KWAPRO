...
<table width="100%" border="0" cellpadding="0" cellspacing="00" align="center" bgcolor="#f4f4f7">
		  ...
		  <tr>
            <td width="100%" height="40" valign="middle" align="center" class="anniu_h"><a href="<?php echo $base.'consult/';?>" class="Black16">咨&nbsp;&nbsp;询</a></td>
		  </tr>
		  <tr>
            <td width="100%" height="5" valign="middle" align="center" bgcolor="#FFFFFF"><font style="font-size:4px;">&nbsp;</font></td>
		  </tr>
...
<font class="fDBlack16">&nbsp;&nbsp;我咨询的问题</font><br><br>
<table width="100%" border="0" cellpadding="0" cellspacing="10" align="center">
<tbody id="content">
		  <?php $i=0; foreach($consults as $item): $i++?>
          <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="10" align="center" style="border:1px #f4f4f7 solid;">
          <tr>
            <td width="100%" height="40" valign="middle" align="left" colspan="2"><a href="<?php echo $base.'consult/consult_detail?id='.$item['id'];?>" class="Red14"><?php echo $i.'、'.$item['title']?></a></td>
          </tr>
		  <tr>
            <td width="8%" height="40" valign="middle" align="right"> <font class="fBlue">回答：</font></td>
			<td width="92%" valign="middle" align="left" style="padding-left:15px; background-color:#f4f4f7;"> <?php echo $item['answer']?></td>
          </tr>
		</table>
		</td>
		</tr>
...
function switch_page()
{
	...
	var url = $('#base').val() + 'consult/sort_consult/';
