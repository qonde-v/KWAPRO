...
<input type="hidden" id="uri" value="<?php echo $base."admin/factory/"?>"/>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div style="display:inline;float:right">
						<a class="ajax-link" href="http://localhost/TIT/admin/factory/edit/-1">
							<i class="icon-edit"></i>
							<span class="hidden-tablet"> 增加厂家</span>
						</a>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th scope="col" style="width:10%;">联系人</th>
								  <th scope="col" style="width:13%;">电话</th>
							...
							<tr>
								...
								<td >
									<?php if(1 == $this->session->userdata('roleId')){?>
										<a class="btn btn-info" href="<?php echo $base."admin/factory/edit?createid=".$record->id?>"><i class="icon-edit icon-white"></i> 编辑</a>
									<?php }?>
								</td>
								<td style="width:5%;">
