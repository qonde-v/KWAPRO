...
<input type="hidden" id="uri" value="<?php echo $base."admin/f_user/"?>"/>
					...
					<div class="box-content">
						<div class="row-fluid">
							<div class="span10">
								...
								<form action="<?php echo $base."admin/f_user/search/"?>" name="frm_search" method="get">
								<label>用户名过滤：
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td style="width:5%;">
									<?php if($this->session->userdata('roleId') == 1) {?>
										<a class="btn btn-danger"  href="javaScript:delete_record(<?php echo $record->uId?>)"><i class="icon-trash icon-white"></i> 删除</a>
									<?php }?>
								</td>
							</tr>
							<?php }?>
